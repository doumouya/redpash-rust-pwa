...
use api::{
    admin, auth, cases, designer, files, group, me, messaging, middleware, monitoring, objects,
    projects, rail, search, settings, state::AppState, types,
};
...
async fn main() -> eyre::Result<()> {
    ...
    let api_router = Router::new()
        ...
        .nest("/me", me::routes())
        .nest("/channels", messaging::channel_routes())
        .nest("/messages", messaging::message_routes())
