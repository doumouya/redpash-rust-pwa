...
| Table density | `prefs.density` → `html[data-density]` | ✅ live — redtable row height; wired 2026-05-21 (see [runbook 0001](../../../internal/runbooks/0001-orphan-prefs.md)) |
| Default CSV delimiter | `prefs.default_delimiter` | 🟡 persisted; badged "Soon" — file-open wiring needs backend ([runbook 0001](../../../internal/runbooks/0001-orphan-prefs.md)) |
| Default encoding | `prefs.default_encoding` | 🟡 persisted; badged "Soon" — file-open wiring needs backend ([runbook 0001](../../../internal/runbooks/0001-orphan-prefs.md)) |
| Export format | `prefs.export_format` | ✅ wired — csv / xlsx / json via `?format=` (see [runbook 0001](../../../internal/runbooks/0001-orphan-prefs.md)) |
