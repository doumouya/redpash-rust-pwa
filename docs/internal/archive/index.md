...
| [rust-dedup-audit-2026-05-24](rust-dedup-audit-2026-05-24.md) | one-shot survey of repeating patterns in the api crate, with measured ROI per pattern | all three "ship" items landed (C `355cde3` pagination dedup; A `194ee26` `From<sqlx::Error>`; B `21dcfc3` `db::count_total`) — net −145 LOC across the api crate. The five "declined" patterns remain documented for reference |
