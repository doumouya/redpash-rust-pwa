...
<!-- Lifted from tools/audit-storage-brainstorming.md (2026-05-30, per
     atomic-doc-plan §10·4). This is a live design spec — the audit
     ingest pipeline it sketches (audit.run / audit.finding / run_diff)
     IS the implementation. Cross-linked from
     ../subsystems/audit-storage.md. -->
