...
How the team works. Each doc captures one practice; the practice
either stays (rewrite when it evolves) or retires (move to `archive/`).

| Doc | What it formalises |
|---|---|
| [audit-cadence](audit-cadence.md) | `audit.sh` as the merge gate; cleaning-cadence rule; slice-grain runs during decomp campaigns |
