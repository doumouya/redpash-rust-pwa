...
case_id: CAS_2C692011AD2C41E88A7C2541EF30AE1E
---

# 0007 — Column drag-reorder cluster (4 layers)

**Date:** 2026-05-31 · **Area:** frontend / `list-page.js` + `home.js` + `table.css` (Home + Monitoring data tables) · **Status:** resolved (commits `c6ced6c`, `0ae04f0`, `c7ca6e6`, `2b8b12d`) · **Case:** `CAS_2C692011AD2C41E88A7C2541EF30AE1E`
...
- **Case ID:** `CAS_2C692011AD2C41E88A7C2541EF30AE1E` (filed 2026-05-31 02:16 UTC via MCP v2, post-restart). The fix shipped in commits `c6ced6c` / `0ae04f0` / `c7ca6e6` / `2b8b12d`; the case backlogged for archival traceability.
