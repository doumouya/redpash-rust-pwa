...
/* ──────────────────────────────────────────────────────────────────────────
   ...
   Usage:  node audit-bro.js [stylesDir]
   Output: ./audit-bro.html  (next to this script)

   Fork of audit.js with three fixes — see the FIX: comments below:
   ...
   (A third "fix" was reverted — a misread of the classesIn() regex. The
    ...
    audit-bro.js rewrites that literal as a \u00a0 escape so it cannot be misread again.)
   ────────────────────────────────────────────────────────────────────────── */
'use strict';
...
var OUT = path.join(__dirname, 'audit-bro.html');
