 ...
 * Doc: docs/internal/code/tools/audit-suite/class-count-audit.md */
/* ── RedPash class-count-audit ──────────────────────────────────────────────
   Em's coherence rule (CAS_37B2E1BF): a MAXIMUM of ONE framework class
   (rp-/rt-/ds-/ws-) + ONE id per element. Class-stacking is the dedup target —
   ...
   audit.run_diff like the rest of the suite. Auto-discovered by tools/audit.sh.
   ────────────────────────────────────────────────────────────────────────── */
'use strict';
...
var FW = /^(rp|rt|ds|ws)-/;                                  // framework atom prefixes
...
var files = walk(path.join(FE, 'scripts'), []).concat(walk(path.join(FE, 'partials'), []));
